...
export default function CallOfDutyDownloadsPage() {
  return (
    <div className="min-h-screen text-white bg-transparent relative">
      ...
      <main className="mx-auto px-6 lg:px-16 py-16 max-w-[1400px] relative z-20">
        <h1 className="text-5xl md:text-6xl font-extrabold mb-14 text-center sm:text-left">Call of Duty Downloads</h1>
