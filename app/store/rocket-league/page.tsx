...
const products = [
  {
    id: "phantom-rocket-league",
    name: "Phantom Rocket League",
    description: "Game-changing features for competitive advantage",
    priceRange: "From $5.99",
    media: "https://i.imgur.com/phantom-rl.mp4",
    variants: [
  ...
  return (
    <div className="min-h-screen text-white">
      ...
      <main className="max-w-[1200px] mx-auto px-5 md:px-8 py-12 desktop-scale-wrapper-products">
        <h1 className="text-4xl md:text-5xl font-bold mb-12">Rocket League</h1>
