...
const products = [
  {
    id: "sol-internal",
    name: "Sol Internal",
    description: "Advanced Valorant cheat with undetected aimbot and ESP",
    priceRange: "From $5.99",
    media: "https://i.imgur.com/sol-internal-val.mp4",
    variants: [
  ...
  },
  {
    ...
    media: "https://i.imgur.com/colorbot-val.mp4",
    variants: [
...
export default function ValorantPage() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-background">
      <Header />
      <main className="max-w-[1200px] mx-auto px-5 md:px-8 py-12 desktop-scale-wrapper-products">
        <h1 className="text-4xl md:text-5xl font-bold mb-12">Valorant</h1>
