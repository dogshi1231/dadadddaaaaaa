...
const products = [
  {
    id: "matcha",
    name: "Matcha",
    description: "Works perfectly on all games with aimbot, ESP, and misc features",
    priceRange: "From $2.50",
    media: "https://i.imgur.com/matcha-roblox.mp4",
    variants: [
...
export default function RobloxPage() {
  ...
  return (
    <div className="min-h-screen text-background bg-transparent">
      <Header />
      <main className="max-w-[1200px] mx-auto px-5 md:px-8 py-12 desktop-scale-wrapper-products">
        <h1 className="text-4xl md:text-5xl font-bold mb-12">Roblox</h1>
