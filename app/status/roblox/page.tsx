...
export default function RobloxStatusPage() {
  const products = productsData.roblox
    ...
    <div className="min-h-screen bg-transparent relative">
      ...
      <main className="mx-auto px-7 lg:px-20 mt-24 relative z-20 max-w-[1400px]">
        <section className="my-16">
          <h2 className="text-white text-[2.8rem] font-extrabold mb-2">Roblox - All Cheats Status</h2>
          ...
          <div
            ...
            "
          >
            <div className="px-7 py-5 text-base text-white/70 border-b border-white/10 font-semibold">Roblox</div>
