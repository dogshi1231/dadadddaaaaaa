...
export default function RainbowSixStatusPage() {
  const products = productsData["rainbow-six-siege-x"]
    ...
    <div className="min-h-screen bg-transparent relative">
      ...
      <main className="mx-auto px-7 lg:px-20 mt-24 relative z-20 max-w-[1400px]">
        <section className="my-16">
          <h2 className="text-white text-[2.8rem] font-extrabold mb-2">Rainbow Six Siege X - All Cheats Status</h2>
