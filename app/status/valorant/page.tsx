...
export default function ValorantStatusPage() {
  const products = productsData.valorant
    ...
    <div className="min-h-screen bg-transparent relative">
      ...
      <main className="mx-auto px-7 lg:px-20 mt-24 relative z-20 max-w-[1400px]">
        <section className="my-16">
          <h2 className="text-white text-[2.8rem] font-extrabold mb-2">Valorant - All Cheats Status</h2>
          ...
          <div
            ...
            "
          >
            <div className="px-7 py-5 text-base text-white/70 border-b border-white/10 font-semibold">Valorant</div>
        ...
        <section className="my-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="bg-[#101010]/90 border border-emerald-600/40 rounded-xl shadow-[0_0_20px_rgba(16,185,129,0.3)] p-4 flex flex-row gap-3">
              <div className="flex items-center justify-center w-8 h-8 rounded-md bg-emerald-600 text-white shadow-[0_0_10px_rgba(16,185,129,0.6)] text-xs font-bold flex-shrink-0">
                ✓
              </div>
            ...
            <div className="bg-[#101010]/90 border border-amber-500/40 rounded-xl shadow-[0_0_20px_rgba(251,191,36,0.3)] p-4 flex flex-row gap-3">
              <div className="flex items-center justify-center w-8 h-8 rounded-md bg-amber-500 text-black shadow-[0_0_10px_rgba(251,191,36,0.6)] text-xs font-bold flex-shrink-0">
                ⚙
              </div>
            ...
            <div className="bg-[#101010]/90 border border-red-500/40 rounded-xl shadow-[0_0_20px_rgba(239,68,68,0.4)] p-4 flex flex-row gap-3">
              <div className="flex items-center justify-center w-8 h-8 rounded-md bg-red-500 text-white shadow-[0_0_10px_rgba(239,68,68,0.6)] text-xs font-bold flex-shrink-0">
                !
              </div>
